...
waterfox-blocker-panel-no-popups =
    .label = No popups
waterfox-blocker-panel-no-large-media =
    .label = No large media
...
waterfox-blocker-panel-firewall-save =
    .label = Save
waterfox-blocker-panel-firewall-revert =
    .label = Revert
...
waterfox-blocker-panel-firewall-cell-unset =
    .label = Unset
waterfox-blocker-panel-firewall-cell-block =
    .label = Block
waterfox-blocker-panel-firewall-cell-allow =
    .label = Allow
waterfox-blocker-panel-firewall-cell-noop =
    .label = Noop
waterfox-blocker-panel-firewall-chooser-unset =
    .label = Unset
waterfox-blocker-panel-firewall-chooser-block =
    .label = Block
waterfox-blocker-panel-firewall-chooser-allow =
    .label = Allow
waterfox-blocker-panel-firewall-chooser-noop =
    .label = Noop
waterfox-blocker-panel-firewall-chooser-url-unset =
    .label = URL unset
waterfox-blocker-panel-firewall-chooser-url-block =
    .label = URL block
waterfox-blocker-panel-firewall-chooser-url-allow =
    .label = URL allow
waterfox-blocker-panel-firewall-chooser-url-noop =
    .label = URL noop
