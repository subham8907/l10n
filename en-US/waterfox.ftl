...
waterfox-blocker-panel-no-popups = No popups
waterfox-blocker-panel-no-large-media = No large media
waterfox-blocker-panel-cosmetic-filtering-disable = Disable cosmetic filtering
waterfox-blocker-panel-cosmetic-filtering-enable = Enable cosmetic filtering
waterfox-blocker-panel-scripting-disable = Disable scripting
waterfox-blocker-panel-scripting-enable = Enable scripting
waterfox-blocker-panel-firewall-title = Dynamic filtering
    .title = Toggle dynamic filtering panel
waterfox-blocker-panel-firewall-description = Temporary rules apply now. Save to make them permanent.
waterfox-blocker-panel-firewall-save = Save
waterfox-blocker-panel-firewall-revert = Revert
waterfox-blocker-panel-firewall-global = Global
waterfox-blocker-panel-firewall-local = Local
waterfox-blocker-panel-firewall-any = Any
waterfox-blocker-panel-firewall-image = Images
waterfox-blocker-panel-firewall-third-party = 3rd-party
waterfox-blocker-panel-firewall-inline-script = Inline scripts
waterfox-blocker-panel-firewall-first-party-script = 1st-party scripts
waterfox-blocker-panel-firewall-third-party-script = 3rd-party scripts
waterfox-blocker-panel-firewall-third-party-frame = 3rd-party frames
waterfox-blocker-panel-firewall-cell-unset = Unset
waterfox-blocker-panel-firewall-cell-block = Block
waterfox-blocker-panel-firewall-cell-allow = Allow
waterfox-blocker-panel-firewall-cell-noop = Noop
waterfox-blocker-panel-firewall-chooser-unset = Unset
waterfox-blocker-panel-firewall-chooser-block = Block
waterfox-blocker-panel-firewall-chooser-allow = Allow
waterfox-blocker-panel-firewall-chooser-noop = Noop
waterfox-blocker-panel-firewall-chooser-url-unset = URL unset
waterfox-blocker-panel-firewall-chooser-url-block = URL block
waterfox-blocker-panel-firewall-chooser-url-allow = URL allow
waterfox-blocker-panel-firewall-chooser-url-noop = URL noop
waterfox-blocker-panel-remote-fonts-disable = Disable remote fonts
waterfox-blocker-panel-remote-fonts-enable = Enable remote fonts
